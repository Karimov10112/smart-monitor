                        ...
                        sortedReminders.map(r => (
                          ...
                          >
                             ...
                             <button 
                               ...
                               className="w-10 h-10 flex items-center justify-center rounded-xl bg-red-500 text-white transition-all hover:bg-red-600 active:scale-90 shadow-lg shadow-red-500/20"
                             >
